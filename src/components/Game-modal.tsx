...
export function GameModal({ gameStatus, word, onNewWord }: GameModalProps) {
  ...
  return (
    ...
    >
      <div className="max-w-sm rounded-xl bg-white p-6 text-center">
        ...
        <button
          onClick={onNewWord}
          className="rounded-lg bg-pink-500 px-4 py-2 text-white outline-none hover:bg-pink-500/80 focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
          autoFocus
        >
          New Word
        </button>
